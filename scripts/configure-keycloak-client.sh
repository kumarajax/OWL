...
KEYCLOAK_PUBLIC_ISSUERS="${KEYCLOAK_PUBLIC_ISSUERS:-https://auth.owl-drive.com/realms/${KEYCLOAK_REALM}}"
...
cors_origins="${FRONTEND_LOCAL_ORIGIN},${FRONTEND_LOOPBACK_ORIGIN},${FRONTEND_PUBLIC_ORIGINS}"
allowed_issuers="${KEYCLOAK_LOCAL_ISSUER},${KEYCLOAK_LOOPBACK_ISSUER},${KEYCLOAK_PUBLIC_ORIGIN}/realms/${KEYCLOAK_REALM},${KEYCLOAK_PUBLIC_ISSUERS}"
