...
SYNC_SCRIPT="$ROOT_DIR/scripts/sync-storage-roots.sh"
...
export APP_STORAGE_LOCAL_CONFIG_FILE="$ROOT_DIR/infra/storage-roots.conf"
export APP_STORAGE_LOCAL_FALLBACK_ROOT="$ROOT_DIR/backend/data/storage"
